...
def write(anyhistograms, file_path: str, *args: Any, **kwargs: Any) -> None:
...
def write_grogu(histograms, file_path: str, gz: bool = False) -> None:
    grogu.write(histograms, file_path, gz=gz)


def write_yoda(histograms, file_path: str, gz: bool = False) -> None:
